...
pub fn root_as_event_packet(
    buf: &[u8],
) -> Result<EventPacket<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_event_packet_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
    fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    root: ::flatbuffers::WIPOffset<EventPacket<'a>>,
) {
