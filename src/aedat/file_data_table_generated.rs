...
pub fn root_as_file_data_table(
    buf: &[u8],
) -> Result<FileDataTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_file_data_table_unchecked(buf: &[u8]) -> FileDataTable<'_> {
    unsafe { ::flatbuffers::root_unchecked::<FileDataTable>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_file_data_table_unchecked(buf: &[u8]) -> FileDataTable<'_> {
    unsafe { ::flatbuffers::size_prefixed_root_unchecked::<FileDataTable>(buf) }
}
